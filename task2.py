...
if __name__ == "__main__":
    ...
    plt.title('Printout of Cross Entropy Loss')
    plt.legend()
    plt.savefig("images/task_2_softmax_loss.png", dpi=200)
    plt.show()
    ...
    plt.xlabel('Number of gradient steps')
    plt.ylabel("Accuracy")
    plt.title('Printout of accuracy')
    plt.legend()
    plt.savefig("images/task_2_softmax_accuracy.png", dpi=200)
    plt.show()